...
{
public:
    Scope(_In_opt_ _Type* pParent, _In_ ::VirtualConsole& console, _In_ const std::wstring& padding, _In_ const std::wstring& name) :
        m_pParent(pParent),
        m_console(console),
        m_padding(padding),
        m_name(name),
    ...
    Scope(_In_opt_ _Type* pParent, _In_ ::VirtualConsole& console, _In_ std::wstring& padding, _In_ std::wstring::const_pointer name) :
        m_pParent(pParent),
        m_console(console),
        m_padding(padding),
        m_name(name),
