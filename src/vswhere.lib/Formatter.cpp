...
Formatter::Formatter(_In_ CommandArgs& args, _In_ ::VirtualConsole& console) :
    m_args(args),
    m_console(console)
{
    m_properties =
...
std::unique_ptr<Formatter> Formatter::Create(_In_ const wstring& type, _In_ CommandArgs& args, _In_ ::VirtualConsole& console)
{
